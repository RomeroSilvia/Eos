...
export type SpecialistProfileRow  = Tables<'specialist_profiles'>;
...
export type SpecialistProfileInsert = TablesInsert<'specialist_profiles'>;
...
export type SpecialistProfileUpdate = TablesUpdate<'specialist_profiles'>;
