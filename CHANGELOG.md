...
- Navegacion por tabs para Home, Rutina, Productos, Progreso y Perfil.
- Pantallas mock de login y registro.
- Componentes base de cards, botones, progreso, rutina, recordatorios y calendario.
- Servicios mock para auth, rutinas, productos, progreso y notificaciones.
- Documentacion inicial de estructura y division por modulos verticales.
